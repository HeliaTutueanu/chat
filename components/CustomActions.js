...
const CustomActions = ({ wrapperStyle, iconTextStyle, onSend, storage, id }) => {
    ...
    const startRecording = async () => {
        try {
            ...
            if (permissions?.granted) {
                await Audio.setAudioModeAsync({   // ios config to allow recording on iPhone devices
    ...
    const stopRecording = async () => {
        await Audio.setAudioModeAsync({   // ios config to stop recording on iPhone devices
